...
// salidas: no tiene
void ListaSimple::insertarAlFinal (int codigo, int dato)
{
     // si no hay elementos
     if (primerNodo == NULL)
     {
         // ambos apuntan al nuevo en memoria
         primerNodo = new Nodo(codigo, dato);
         ultimoNodo = primerNodo; // ambos apuntan al nuevo
     }
     else
     {
         // se crea el nuevo nodo
         Nodo *nuevo = new Nodo(codigo, dato);
...
void ListaSimple::insertarAlFinal (Nodo* actual)
{
     // si no hay elementos
     if (primerNodo == NULL)
     {
